...
df1 = pd.read_csv(r'PMRC15925.csv', index_col=0,header=None)
...
def fetchData(csv_file='redefinedinputparameters.csv'):
    servicesLst = []
...
# ------------------------- Configuration -------------------------
INPUT_FILE_LOCATION = "redefinedinputparameters.csv"         # Replace with your path
TEMP_LOCATION = ""                    
...
solver = SolverFactory('mbnb', executable=r'C:\Users\ankit\LINE-3_4\minotaur-0.4.1-win64\bin\mbnb.exe')
...
solver.options['--obj_gap_percent'] = 50
...
duty2.to_excel(r"PMRC15925v6.xlsx")
