...
from worker import process_file, job_registry, process_fileL34, process_fileL5, process_fileL7, process_fileL342
import os
...
@app.post("/simulateL342")
async def simulateL342(
    background_tasks: BackgroundTasks,
    execution_id: str = Form(...),
    file: UploadFile = File(...),
    user_id: str = Form(""),
    ...
    # Start background processing
    background_tasks.add_task(
        process_fileL342, execution_id, saved_path, user_id, user_name,user_email, parsed_stepping_back,timetable_type  
    )
...
async def simulateL7(
    ...
    # Start background processing
    background_tasks.add_task(
        process_fileL7, execution_id, saved_path, user_id, user_name,user_email, parsed_stepping_back,timetable_type  
    )
